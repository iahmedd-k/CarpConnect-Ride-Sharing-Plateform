        ...
        <div className="space-y-4 max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <motion.div
                    ...
                    className="w-full md:w-1/3 bg-card border border-border/50 rounded-2xl p-5 shadow-sm flex flex-col items-center justify-center text-center space-y-3"
                >
                    <div className="w-20 h-20 rounded-full bg-amber-500/10 flex items-center justify-center mb-2">
                        <Star className="w-10 h-10 text-amber-500 fill-amber-500" />
                    </div>
                    <div className="text-4xl font-display font-black text-foreground">{averageRating}</div>
                    ...
                    <p className="text-xs font-medium text-muted-foreground tracking-wide uppercase">{totalReviews} Reviews</p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="w-full md:w-2/3 bg-card border border-border/50 rounded-2xl p-5 shadow-sm flex flex-col"
                >
                    <h3 className="font-display font-bold text-lg mb-4">Driver Compliments</h3>
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 flex-1">
                        {(() => {
                            ...
                            return badges.map(badge => {
                                ...
                                return (
                                    <div key={badge.label} className={`bg-${badge.color}-500/10 border border-${badge.color}-500/20 rounded-2xl p-3 flex flex-col justify-center text-center hover:bg-${badge.color}-500/20 transition-all cursor-default`}>
                                        ...
                                        <span className="font-black text-lg text-foreground">{count}</span>
                                    </div>
                                );
                            });
                        })()}
            ...
            >
                <div className="flex items-center justify-between mb-5">
                    <h3 className="font-display font-bold text-lg">Recent Reviews</h3>
                </div>
